...
class Feedback
{
    ...
    public function toHtml()
    {
        ...
        return 'Error: ' . $this->isError . '<br>' .
        'Feedback: ' . $this->text . '<br>' .
        'Error message:' . $this->errorMessage . '<br>' .
        'Error code: ' . $this->errorCode . '<br>' .
        'Error code driver: ' . $this->errorCodeDriver . '<br>' .
        'Messages: <br>';
    }
}
